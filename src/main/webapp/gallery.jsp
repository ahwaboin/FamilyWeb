...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <!-- 
	...
	<header id="fh5co-header" class="fh5co-cover fh5co-cover-sm" role="banner" style="background-image:url(./resources/backImg/gallery.jpg);">
				...
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="display-t">
						<div class="display-tc animate-box" data-animate-effect="fadeIn">
							<h1>Gallery</h1>
							<h2>The family is one of nature's masterpices.</h2>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row row-bottom-padded-md">
				<div class="col-md-12">
					<ul id="fh5co-gallery-list">
						<c:forEach items="${gallery }" var="gall" varStatus="statu">
							<li class="one-third animate-box" data-animate-effect="fadeIn" style="background-image: url(./resources/images/${gall.mainImg}); "> 
								<form method="post" action="./galleryOne" id="galleryOne${statu.index}">
									...
									<a href="#galleryOne${statu.index}" onclick="document.getElementById('galleryOne${statu.index}').submit();">
